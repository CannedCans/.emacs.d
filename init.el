...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet projectile markdown-mode iedit git-timemachine flx-ido elfeed anzu ws-butler solarized-theme smart-mode-line org-journal org-brain multiple-cursors mediawiki magit-popup magit lv js2-mode hydra helm-org-rifle flycheck-pos-tip flycheck-irony flycheck-haskell company-math chess aggressive-indent))))
(custom-set-faces
